...
def getThenWaitReady(browser, url):
    ...
    while (isNotReady):
        ...
        for entry in browser.get_log('browser'):
            if ('[ArtTest.js]:ready' in entry['message']):
                isNotReady = False
                break
...
with open('fragments.csv', 'r', newline='') as csvfile:
    ...
    for row in reader:
        ...
        with open(r'./captures/' + info['hash'] + '.png', 'wb') as f:
        # with open(r'fragments.png', 'wb') as f:
            f.write(png1)
