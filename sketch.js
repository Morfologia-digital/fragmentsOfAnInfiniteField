...
function flor(px_, py_, ang_, index, fil_, anc, cor) {
  ...
  this.petalaPlot = function () {
    ...
    for (let i = 0; i < this.quant; i++) {
      ...
      line(
        0,
        0,
        random((DIM / (this.esc / 2)) * 0.75, DIM / (this.esc / 2)),
        0
      );
    ...
    for (let i = 0; i < this.quant; i++) {
      ...
      ellipse(
        0,
        (-DIM / (this.esc * 2)) * escAlt2,
        DIM / (this.esc / 2),
        (DIM / this.esc) * escAlt2
      );
      strokeWeight(DIM / this.esc / 30);
  ...
  this.corona = function () {
    ...
    for (let i = 0; i < this.fil; i++) {
      ...
      ellipse(
        DIM / (this.esc / dado3),
        0,
        DIM / this.esc / random(12, 16),
        DIM / this.esc / random(8, 12)
      );
    ...
    for (var j = 0; j < this.fil / 2; j++) {
      ...
      ellipse(
        DIM / (this.esc / dado2),
        0,
        DIM / this.esc / random(12, 18),
        DIM / this.esc / random(9, 12)
      );
  ...
  this.stamen = function () {
    ...
    translate(this.px, this.py);
    rotate(
      radians(map(sementes[floor(random(sementes.length))], 0, 9, 0, 360))
    );
    for (var i = 0; i < sta; i++) {
